...
NODE_LINK="https://nodejs.org/dist/v17.2.0/node-v17.2.0-linux-x64.tar.xz"
...
"$NODE_DIR/bin/npm" config set prefix "$NODE_DIR/lib"
"$NODE_DIR/bin/npm" install --prefix "$NODE_DIR/lib" npm@latest
